...
M = table2array(readtable('Prueba_Erick.csv'));
...
% P2 = abs(EMG_izq/L);
% P1izq = P2(1:L/2+1);
% P1izq(2:end-1) = 2*P1izq(2:end-1);
% plot(f,P1izq) 
% subplot(3,1,2)
% EMG_der = fft(EMG_der);
% P2 = abs(EMG_der/L);
% P1der = P2(1:L/2+1);
% P1der(2:end-1) = 2*P1der(2:end-1);
% plot(f,P1der) 
% subplot(3,1,3)
% EMG_arriba = fft(EMG_arriba);
% P2 = abs(EMG_arriba/L);
% P1arriba = P2(1:L/2+1);
% P1arriba(2:end-1) = 2*P1arriba(2:end-1);
% plot(f,P1arriba) 
% hold off
